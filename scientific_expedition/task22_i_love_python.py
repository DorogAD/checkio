...
an additional mission special for the haters). Publishing the default solution will only earn you 0 points as the goal
...
def i_love_python() -> str:
    """
        ...
        because it blows your mind like a woman)))
    """
