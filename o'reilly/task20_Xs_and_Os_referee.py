...
def checkio(game_result: List[str]) -> str:
    for i in range(3):
        for j in range(3):
            if game_result[i][0] == game_result[i][1] == game_result[i][2] == 'X' or game_result[0][j] == \
                    game_result[1][j] == game_result[2][j] == 'X' or game_result[0][0] == game_result[1][1] == \
                    game_result[2][2] == 'X' or game_result[2][0] == game_result[1][1] == game_result[0][2] == 'X':
                return 'X'
            elif game_result[i][0] == game_result[i][1] == game_result[i][2] == 'O' or game_result[0][j] == \
                    game_result[1][j] == game_result[2][j] == 'O' or game_result[0][0] == game_result[1][1] == \
                    game_result[2][2] == 'O' or game_result[2][0] == game_result[1][1] == game_result[0][2] == 'O':
                return 'O'
    return 'D'
